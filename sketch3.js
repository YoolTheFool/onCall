...
let order = [
  ...
  {
    text: 'You smoothly slide into warp formation',
    show_time: 244,
    show_duration: 4,
    shown: false,
    isLSM: false,
...
var lsmPlayer = new Tone.Player("LSMChord.wav").toMaster();
var tubePlayer = new Tone.Player("TUBE.wav").toMaster();
...
var Player = new Tone.Player("fullNoLSM3.wav").toMaster();
